...
const MyTestimonials = () => {
  return (
    <section id="відгуки" className="pt-32">
      {/* HEADING */}
      <motion.div
      ...
      <div className="gap-8 md:flex md:flex-wrap md:justify-between">
        <motion.div
          className="rounded-custom relative mx-auto mt-48 flex h-[350px] basis-1/4 flex-col justify-end
        ...
        <motion.div
          className="rounded-custom relative mx-auto mt-48 flex h-[350px] basis-1/4 flex-col justify-end bg-red
        ...
        <motion.div
          className="rounded-custom relative mx-auto mt-48 flex h-[350px] basis-1/4 flex-col justify-end bg-yellow
        ...
        <motion.div
          className="rounded-custom relative mx-auto mt-48 flex h-[350px] basis-1/4 flex-col justify-end bg-blue
        ...
        <motion.div
          className="rounded-custom relative mx-auto mt-48 flex h-[350px] basis-1/4 flex-col justify-end
            bg-red before:absolute before:left-1/2 before:-ml-[110px] before:content-person5 xxs:p-2 xxs:before:top-[-140px] md:p-2 md:before:top-[-170px]"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 0.6 }}
