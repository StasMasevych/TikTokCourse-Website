  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      >
        ...
        <p className="mt-10">
          Сотні учнів уже пройшли мій ТікТок курс, і можуть оцінити всю
          крутезність курсу!
        </p>
      </motion.div>
      ...
      <div className="gap-8 md:flex md:flex-wrap md:justify-between">
        ...
        >
          ...
          <p className="xxs:text-md text-center md:text-sm">
            ...
            підписників і вже 20 продажок по 350гривень, з повного 0 Буду
            дякувати вам вічно! Радий, що ви на зв’язку!
          </p>
        </motion.div>
      </div>
    </section>
