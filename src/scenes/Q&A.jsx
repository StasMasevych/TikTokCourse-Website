...
const faqs = [
  ...
  },
  {
    ...
    text: 'Так❤️ При внесені першого будь-якої суми платежу за вами бронюється місце на бажаний курс🔥 та його стара ціна (при подальшому підйомі ви не переплачуєте❤️) Також ви можете розбити на будь - які зручні для себе платежі суми яких можуть відрізнятися та оплачуватись як помісячно, так потижнево, ви просто надсилаєте мені скріни і при сплаті останнього платежу одразу отримуєте доступ на навчання🎉🙌, а в разі придбання ВІП🌟Курсу🔥 одразу вступає в силу і кураторство!😎',
  },
];
